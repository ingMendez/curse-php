...
<body>
	<form action="#" method="POST">
		<?php
			...
			if(isset($_POST['nombre'])){  /// aqui puede ser cuaquier campo es este caso utilizamos nombre. pero no importa el campo
				$nombre = $_POST['nombre'];
				...
				if($nombre == ""){
					array_push($campos, "El campo Nombre no pude estar vacío");  /// array_push se utiliza para agragar valores a algun formularo.
				}
		...
		<p>
			...
			<select name="pais" id="">
				...
				<option value="mx" <?php if($pais == "mx") echo "selected" ?> >Republic Dominican</option>
				...
				<option value="ch" <?php if($pais == "ch") echo "selected" ?>>canada</option>
			</select>
		</p>
