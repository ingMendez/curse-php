...
<body>
	...
	<div id="formularios">
		<form action="recibir_post.php" id="form_session" method="post"> <!--  en el formulario se debe espesificar que motodo usaras -->
			...
			<p class="center-content">
				...
				<a href="recibir_get.php?tipo_usuario=nuevo&navegador=chrome">Registra cuenta</a> <?php // para usar link necesitamos usar el metodo get?>
			</p>
		</form>	
