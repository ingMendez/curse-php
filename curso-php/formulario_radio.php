...
<body>
	...
	// TODO (3) Validar que el campo no esté vacío
				...
				if($lenguajes == "" || count($lenguajes) < 2){
					array_push($campos, "Selecciona al menos dos lenguajes de programación.");  //el array_push se utiliza para agregar elementos a un array en php.
				}

				if(count($campos) > 0){   // la funcion cout() se utiliza para contabilizar un array en php.
		...
		<p>
			...
			<select name="pais" id="">
				...
				<option value="mx" <?php if($pais == "mx") echo "selected"?> >México</option> <!-- esto es para validar si el campo seleccionado es igual  <?//php if($pais == "mx") echo "selected"?> -->
